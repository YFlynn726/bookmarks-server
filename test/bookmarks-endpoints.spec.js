    ...
    context(`Given an XSS attack bookmark`, () => {
      ...
      it("removes XSS attack content", () => {
        return supertest(app)
          ...
          .expect(200)
          .expect((res) => {
            expect(expectedBookmarks.title).to.eql(expectedBookmarks.title);
            expect(expectedBookmarks.description).to.eql(
              expectedBookmarks.description
            );
          });
      });
    });
